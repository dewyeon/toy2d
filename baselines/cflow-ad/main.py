...
def main(c):
    ...
    if c.user == 'sojin':
        if c.dataset == 'mvtec':
            c.data_path = '/home/sojin/dataset/mvtec'
            # c.data_path = '/home/sojin/dataset'
        elif c.dataset == 'stc':
            c.data_path = './dataset/STC/shanghaitech'
        elif c.dataset == 'multi_mvtec':
            c.data_path = '/data1/STC'
        elif c.dataset == 'video':
            c.data_path = c.video_path
        elif c.dataset == 'toy_example':
            c.data_path = './' #TODO
        else:
            raise NotImplementedError('{} is not supported dataset!'.format(c.dataset))
    elif c.user == 'juyeon':
        if c.dataset == 'mvtec':
            c.data_path = '/home/juyeon/data/mvtec'
        elif c.dataset == 'stc':
            c.data_path = '/home/juyeon/data/stc'
        elif c.dataset == 'multi_mvtec':
            c.data_path = '/home/juyeon/data/mvtec'
        elif c.dataset == 'video':
            c.data_path = c.video_path
        ...
        if c.dataset == 'mvtec':
            c.data_path = '/root/dataset/mvtec'
        elif c.dataset == 'stc':
            c.data_path = '/root/dataset/STC'
        elif c.dataset == 'multi_mvtec':
            c.data_path = '/root/dataset/mvtec'
        elif c.dataset == 'video':
            c.data_path = c.video_path
        ...
        raise NotImplementedError('{} is not supported user!'.format(c.user))
    # output settings
    c.verbose = True
